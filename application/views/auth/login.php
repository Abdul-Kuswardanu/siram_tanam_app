  ...
  <div class="card shadow-sm border-0" style="width: 100%; max-width: 450px;">
    <div class="card-body">
      ...
      <form method="post" action="<?= site_url('auth/login'); ?>">
        ...
        <button type="submit" class="btn btn-primary w-100 mt-3">➡️ Masuk</button>
      </form>

      <p class="mt-4 text-center text-muted">Belum punya akun? <a href="<?= site_url('SmartSiram/daftar') ?>">Daftar di sini</a></p>
